  ...
  return (
    <aside className="w-64 flex-shrink-0 bg-gray-900 text-white flex flex-col justify-between min-h-screen">
      ...
      <div className="p-4 border-t border-gray-800 space-y-3">
        <button
          onClick={logout}
          className="flex w-full items-center gap-2.5 rounded-xl px-4 py-2 text-xs font-semibold text-gray-400 hover:bg-gray-800 hover:text-red-400 transition"
        >
        ...
        <div className="rounded-xl bg-gray-800/60 p-3 text-xs text-gray-400">
          <p className="font-medium text-gray-300">RBAC Enabled</p>
          <p className="text-[11px] text-gray-500 mt-0.5">Enterprise Desk v1.0</p>
        </div>
      </div>
    </aside>
  );
