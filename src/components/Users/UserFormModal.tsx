  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 mt-2">
        ...
        {/* Password and Phone - Stack on mobile */}
        ...
        {/* Department, Role, Status - Stack on mobile, 3 columns on sm+ */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 dark:text-gray-100 px-3 py-2.5 text-sm outline-none focus:border-blue-600 dark:focus:border-blue-500 transition-colors"
            >
